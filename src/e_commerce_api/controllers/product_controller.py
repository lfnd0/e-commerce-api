...
def fetch_product_by_id_with_schema(product_id: int):
    fetch_product_by_id_with_schema_use_case = (
        make_fetch_product_by_id_with_schema_use_case()
    )
    product = fetch_product_by_id_with_schema_use_case.execute(product_id)
